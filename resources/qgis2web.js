...
map.getView().fit([12537331.836859, -898900.018352, 12541670.556969, -896592.988856], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleText.className = 'map-title';
        titleText.innerHTML = 'Peta Tematik Persebaran Rumah Makan Arjowinangun';
...
var Abstract = new ol.control.Control({
    element: (() => {
        ...
        if (386 > 240) {
            linkElement.setAttribute("onclick", "toggleAbstract()");
            linkElement.innerHTML = 'Kelurahan Arjowinangun merupakan wilayah di Kota Malang dengan aktivitas ekonomi lokal yang cukup berkembang, khususnya pada sektor kuliner. Peta tematik ini menampilkan persebaran rumah makan di Kelurahan Arjowinangun untuk memberikan gambaran spasial mengenai lokasi tempat makan terhadap jaringan jalan dan batas wilayah, sebagai informasi pendukung analisis dan perencanaan wilayah.';

            window.toggleAbstract = function() {
                if (linkElement.classList.contains("project-abstract-collapsed")) {
                    linkElement.classList.remove("project-abstract-collapsed");
                    linkElement.classList.add("project-abstract-uncollapsed");
                    linkElement.innerHTML = 'Kelurahan Arjowinangun merupakan wilayah di Kota Malang dengan aktivitas ekonomi lokal yang cukup berkembang, khususnya pada sektor kuliner. Peta tematik ini menampilkan persebaran rumah makan di Kelurahan Arjowinangun untuk memberikan gambaran spasial mengenai lokasi tempat makan terhadap jaringan jalan dan batas wilayah, sebagai informasi pendukung analisis dan perencanaan wilayah.';
                } else {
                    linkElement.classList.add("project-abstract-collapsed");
                    linkElement.classList.remove("project-abstract-uncollapsed");
                    linkElement.innerHTML = 'ℹ️';
                }
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_Lokasi_Tempat_Makan_11,
    colName: 'Lokasi',
    zoom: 10,
    collapsed: true,
    map: map,
